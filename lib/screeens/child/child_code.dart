                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (args != null && args.containsKey('connectionString')) {
                              handleChildCode(context, args['connectionString']);
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text("Error: Child code is missing!")),
                              );
                            }
                          },
...
void handleChildCode(BuildContext context, String childCode) {
  Navigator.pushNamed(
    context,
    '/child_dashboard',
